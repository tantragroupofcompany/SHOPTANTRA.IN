    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        <header className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-extrabold tracking-tight">CEO & MD Dashboard</h1>
            <p className="text-gray-300 text-sm mt-1">Operations, sales, orders, and performance.</p>
          </div>
        ...
        <div className="bg-white/10 rounded-xl p-6 border border-white/10">
          ...
          <p className="text-sm text-gray-300">CEO & MD controls placeholder. Connect backend APIs to populate live metrics.</p>
        </div>
      </div>
    </div>
  );
