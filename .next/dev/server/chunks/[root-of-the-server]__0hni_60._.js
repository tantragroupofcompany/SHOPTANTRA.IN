...
"[project]/src/app/api/seller/settings/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        let settings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].sellerSettings.findUnique({
            where: {
                sellerId
            }
        });
        if (!settings) {
            ...
            settings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].sellerSettings.create({
                data: {
                    sellerId,
...
async function PUT(request) {
    try {
        ...
        const settings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].sellerSettings.upsert({
            where: {
                sellerId
            },
            update: updateData,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0hni_60._.js.map