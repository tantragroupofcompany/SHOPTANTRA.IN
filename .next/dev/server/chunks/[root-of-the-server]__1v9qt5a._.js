...
"[project]/src/app/api/seller/coupons/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const coupons = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].coupon.findMany({
            where: {
                sellerId
            },
            orderBy: {
...
async function POST(request) {
    try {
        ...
        const { sellerId: sellerIdParam, userId, code, discountType, discountValue, minSpend, expiryDate, status } = body;
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].coupon.findUnique({
            where: {
                code: cleanCode
            }
        });
        ...
        const newCoupon = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].coupon.create({
            data: {
                sellerId,
                code: cleanCode,
                discountType,
...
async function PUT(request) {
    try {
        const body = await request.json();
        const { id, code, discountType, discountValue, minSpend, expiryDate, status } = body;
        if (!id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].coupon.update({
            where: {
                id
            },
            data: updatePayload
...
async function DELETE(request) {
    try {
        ...
        const deleted = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].coupon.delete({
            where: {
                id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1v9qt5a._.js.map