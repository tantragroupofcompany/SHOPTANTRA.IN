...
"[project]/src/app/api/admin/commissions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (type === 'settings') {
            const settings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].globalSettings.upsert({
                where: {
                    id: 'settings'
                },
                update: {},
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ...
                data: {
                    ...
                    categoryCommissions: (()=>{
                        try {
                            return JSON.parse(settings.categoryCommissions);
                        } catch  {
                            return {};
                        }
                    })()
        ...
        const commissions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].commission.findMany({
            include: {
                order: {
                    select: {
                        orderNumber: true
...
async function POST(request) {
    try {
        ...
        const catCommStr = categoryCommissions !== undefined ? typeof categoryCommissions === 'string' ? categoryCommissions : JSON.stringify(categoryCommissions) : undefined;
        const settings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].globalSettings.upsert({
            where: {
                id: 'settings'
            },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__20j1_0h._.js.map